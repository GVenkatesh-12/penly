...
5. Do not add a library for functionality that requires fewer than roughly 100 lines of clear, well-tested code unless the library solves a difficult platform compatibility problem.
